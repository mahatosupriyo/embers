            ...
            <div className={styles.footerwraper}>
                ...
                <div className={styles.footercontent}>
                    ...
                    <div className={styles.socialscontainer}>
                        ...
                        <div className={styles.socials}>
                            <Link target="_blank" draggable="false" href="" className={styles.socialmedialink}>
                ...
                <div className={styles.footercontent}>
                    <h4 className={styles.passiontxt} style={{ textWrap: 'nowrap', width: '100%', maxWidth: '50%' }}>
                        Made with
                        <svg xmlns="http://www.w3.org/2000/svg" height="14" viewBox="0 0 56 56" fill="none">
                        ...
                        in India  © 2025 Ember's
                    </h4>
                    <p>
                        All rights reserved. No part of this website or its content may be reproduced, distributed, or transmitted in any form or by any means, including photocopying, recording, or other electronic or mechanical methods, without the prior written permission of Ember's, except in the case of brief quotations embodied in critical reviews and certain other noncommercial uses permitted by copyright law. For permission requests, contact Ember's.
                    </p>
                </div>
